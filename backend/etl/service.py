...
class GeocodingETLService:
    ...
    def run(
        ...
        """Parse all districts for each locality."""
        ...
        for locality in localities:
            if isinstance(locality, int):
                ...
                if locality is None:
                    ...
                    raise ValueError
            self._process_locality(locality)

    def _process_locality(self, locality: str) -> None:
        """Parse all districts for a single locality."""
